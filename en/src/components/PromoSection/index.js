                ...
                <Container>
                    <h1 className="promo-heading">
                        <div className="promo-title">
                            <p className="_text-on-load">Swim System - The Power of Motion</p>
                        </div>
                    </h1>
                </Container>
            </div>
                ...
                <Container className="container">
                    <div className="promo-section__content">
                        <div className="promo-headcon">
                            <h1 className="promo-heading">
                                <div className="promo-title">
                                    <p className="front _text-on-load">Swim System - The Power of Motion</p>
                                    <p className="back _text-on-load">Swim System - The Power of Motion</p>
                                </div>
                            </h1>
                        </div>
                        <div className="promo-description">
                            <p className="_text-on-load">
                                Swim System is a team of young and passionate swimmers. Our achievements are a combination of an interesting and consistent training process, healthy environment, and people's enthusiasm that help us become better and reach our goals.
                            </p>
                        </div>
                    </div>
                </Container>
